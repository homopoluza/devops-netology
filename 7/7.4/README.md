...
vagrant@vagrant:/vagrant/tfc-getting-started$
```

![getting-started](https://github.com/homopoluza/devops-netology/blob/main/7/7.4/7-4-1.png)
...
```
Используется для поднятия множества инстансев. К сожалению, у меня нету доступа к AWS.
```
